...
from tools.db import execute_readonly_orm_code, execute_readonly_sql, get_db_schema
...
def get_tools_list(
    ...
    if enable_db_query:
        base = base + [get_db_schema, execute_readonly_orm_code, execute_readonly_sql]
